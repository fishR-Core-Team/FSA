...
* `agePrecision()`: Modified. Added intermediate and summary calculations for median and modal age; mean absolute deviation and standard deviation; and APE and CV with the median rather than the mean as the divisor. Updated tests and examples. Other minor modifications to the function code. Addresses [#41](https://github.com/droglenc/FSA/issues/41) and [#49](https://github.com/droglenc/FSA/issues/49).
