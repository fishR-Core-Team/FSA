...
Use of `wsVal()` requires spelling (and capitalizing) the name as it appears in `WSlit`. On can see all species names availble in `WSlit` with `wsVal()` without any arguments.
