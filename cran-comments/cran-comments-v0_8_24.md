* This updates the existing FSA package on CRAN with corrections, largely to the use of \concept(), as directed by CRAN (per e-mail from Kurt Hornik on 17-May-19).
