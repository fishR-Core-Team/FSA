...
#' 
#' @source Quinlan, H.R. 1999. Biological Characteristics of Coaster Brook Trout at Isle Royale National Park, Michigan, 1996-98. U.S. Fish and Wildlife Service Ashland Fishery Resources Office report. November 1999.  Was originally available at \url{www.fws.gov/midwest/ashland/brook/biochar/biolchar.html}.
#' 
#' @keywords datasets
#' 
#' @examples
