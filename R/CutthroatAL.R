...
#' 
#' @source Simulated from Appendix A.5 of Lum, J.L., J.D. Jones, and S.G. Taylor. 2001.  Dolly varden and cutthroat trout population in Auke Lake, Southeast Alaska, during 2000.  Alaska Department of Fish and Game Fisheries Data Series 01-33.
#' 
#' @keywords datasets
#' 
#' @examples
