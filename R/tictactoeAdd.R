...
#' @param ci.type A string representing the method to use for computing the binomial confidence intervals.  See details of \code{binCI}.
#' @param ci.lwd A numeric designating the line width for the condince interval lines.
#' @param pt A numeric representing the type of symbol to use for the predator/prey PSD point.
#' @param pt.col A string representing the color of the symbol used for the predator/prey PSD point.
#' @param pt.cex A numeric representing the relative size of the symbol used for the predator/prey PSD point.
#' @param label A string used to label the point.
#' @param lbl.pos A string that indicates where to place the label.
#' @param lbl.col A string that indicates the color to use for the label.  Defaults to same color as the color of the point.
