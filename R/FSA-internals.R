...
#'and \code{\link{removal}}.
#'\item \code{ci.fp} and \code{ci.fp1} are used in \code{\link{fitPlot}}.
#'\item \code{addOutlierTestResults}, \code{addLoessLine}, and \code{getMainTitle}
#'are all used in \code{\link{residPlot}}.
#'\item \code{listSpecies} is used in \code{\link{psdVal}}, \code{\link{psdCalc}},
#'\code{\link{psdPlot}}, \code{\link{wrAdd}}, and \code{\link{wsVal}}.
#'\item \code{getVarFromFormula} is used in \code{\link{ageKey}}, \code{\link{lencat}}
#'\code{\link{psdCalc}}, \code{\link{psdDataPrep}}, \code{\link{psdPlot}}, and
#'\code{\link{recodeSpecies}}.
#'\item \code{psdLitCheck} is used in \code{\link{psdVal}}, \code{\link{psdCalc}}, and
#'\code{\link{psdPlot}}.
...
#'\item \code{getAllDependencies}, \code{getFilePrefix}, \code{makeFilename}, 
#'\code{makeItemsToRemove}, \code{printProgressMsg}, \code{processSessionInfo} are
#'all used in the \code{swvXXX} utility functions.
