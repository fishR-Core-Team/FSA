...
#'@param x A quantitative explanatory variable or a formula of the form
#'\code{factor~quant}.
...
plotBinResp.default <- function(x,y,xlab=paste(deparse(substitute(x))),ylab=paste(deparse(substitute(y))),
