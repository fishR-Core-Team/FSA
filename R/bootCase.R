...
#'
#' Provides S3 methods to construct non-parametric bootstrap confidence intervals, hypothesis tests, and plots of the parameter estimates for a \code{bootCase()} object (from the \pkg{car} package).
#'
