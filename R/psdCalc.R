...
#'
#'Convenience function for caculating PSD-X values for all lengths in the
#'Gabelhouse five-cell categories.
#'
#'This computes the PSD-X values, with associated confidence intervals, for
#'each represented length in the Gabelhouse five-cell length categories.
#'
