...
#'\pkg{popbio} package.
#'@param use.log A logical indicating if the population sizes should be logged
#'before plotting.
...
#'and \code{b} for both.
#'@param lwd A numeric indicating the line width to use.
#'@param add A logical indicating whether the data should be added to a
