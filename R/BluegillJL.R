...
#'
#'Each line consists of the capture history over two samples of Bluegill (\emph{Lepomis macrochirus}) in Jackson Lake (MI).  This file contains the capture histories for only 6" Bluegill.
#'
#' @name BluegillJL
#'
#' @docType data
