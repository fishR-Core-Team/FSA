...
#'
#'This function will compute confidence interval for three possible methods
#'chosen with the \code{type} argument.
#'
#'\tabular{ll}{
#'\code{type="wilson"} \tab Wilson's (Journal of the American Statistical Association, 1927)
#'confidence interval for a proportion.  This is the score CI, based on inverting
#'the asymptotic normal test using the null standard error. \cr
#'\code{type="exact"} \tab Computes the Clopper/Pearson exact CI for a binomial
#'success probability. \cr
#'\code{type="asymptotic"} \tab This uses the normal distribution approximation. \cr
#'}
#'
#'Note that Agresti and Coull (2000) suggest that the Wilson interval is the
#'preferred method and is, thus, the default \code{type}.
#'
#'@note This is primarily a wrapper function for \code{binconf} in the \pkg{Hmisc}
...
#'for interval estimation of binomial proportions.  American Statistician, 52:119-126.
#'@export
#'@keywords htest
#'@examples
