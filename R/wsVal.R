...
#' @param simplify A logical that indicates whether the \sQuote{units}, \sQuote{ref}, \sQuote{measure}, \sQuote{method}, \sQuote{comments}, and \sQuote{source} fields should be included (\code{=FALSE}) or not (\code{=TRUE}; DEFAULT).
#'
#' @return A data frame that consists of one line from \code{WSlit} related to the standard weight equation for the given species, units, and ref.
#'
