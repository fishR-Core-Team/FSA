#' @title Constructs the base tic-tac-toe graph for presenting predator-prey PSD values.
#'
#' @description Constructs the base tic-tac-toe graph for presenting predator-prey PSD values.  Predator prey values are added with \code{\link{tictactoeAdd}}.
#'
#' @details This function simply creates the base tic-tac-toe graph.  Observed values, with confidence intervals, can be added to this graph with \code{\link{tictactoeAdd}}.
#'
...
#' @param bnd.col A string designating a color for the boundaries of the \dQuote{in balance} regions.
#' @param bnd.lwd A numeric designating the line width for the boundaries of the \dQuote{in balance} region.
#' @param bnd.lty A numeric designating the line type for the boundaries of the \dQuote{in balance} regions.
#'
#' @return None.  However, a graphic is produced.
#'
#' @author Derek H. Ogle, \email{dogle@@northland.edu}
#'
#' @seealso \code{\link{tictactoeAdd}}, \code{\link{psdVal}}, \code{\link{psdCalc}}, \code{\link{psdPlot}}, \code{\link{psdDataPrep}}, \code{\link{PSDlit}}.
#'
