...
#'
#'Constructs the base tic-tac-toe graph for presenting predator-prey PSD values.  Predator prey values are added with \code{\link{tictactoeAdd}}.
#'
#'This function simply creates the base tic-tac-toe graph.  Observed values, with confidence intervals, can be added to this graph with \code{\link{tictactoeAdd}}.
#'
