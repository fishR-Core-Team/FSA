...
#'\describe{ \item{days}{Elapsed duration of the experiment.}
#'\item{cells}{Number of cells in the population.} }
#'@source McKendrick, A.G. and M. Kesava Pai. 1911. The Rate of Multiplication
#'of Micro-Organisms: a Mathematical Study. Proceedings of the Royal Society of
