...
#'
#'Convert a \dQuote{directional} (e.g., \sQuote{NE}, \sQuote{S}, etc.) position
...
#'@return A vector of length two that contains the x- and y-coordinate
...
#'@examples
#'## Make a dummy plot
#'plot(c(0.75,2,3.25),c(2,2,2),xlim=c(0,4),ylim=c(1,3),pch=16)
#'
#'## Add some labels
