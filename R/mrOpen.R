#' @title Estimate initial population size for multiple census mark-recapture data from an open population.
#'
...
#'
#' @details If \code{mb.top} contains an object from the \code{capHistSum} function then \code{mb.bot} can be left missing or will be ignored.  In this case, the function will extract the needed data from the \code{methodB.top} and \code{methodB.bot} portions of the \code{CapHist} class object.
#'
...
#'    \item phi.type The provided type of standard error for phi that was used.
