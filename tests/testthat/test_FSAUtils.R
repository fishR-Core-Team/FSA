...
test_that("fishR() error messages and return values",{
  ...
  ## check return values
  tmp <- fishR()
  expect_equal(tmp,"https://fishr.wordpress.com")
  tmp <- fishR("IFAR")
  expect_equal(tmp,"https://fishr.wordpress.com/ifar/")
  tmp <- fishR("general")
  expect_equal(tmp,"https://fishr.wordpress.com/vignettes/")
  tmp <- fishR("AIFFD")
  expect_equal(tmp,"https://fishr.wordpress.com/books/aiffd/")
  tmp <- fishR("posts")
  expect_equal(tmp,"https://fishr.wordpress.com/news/")
  tmp <- fishR("books")
  expect_equal(tmp,"https://fishr.wordpress.com/books/")
  tmp <- fishR("news")
  expect_equal(tmp,"https://fishr.wordpress.com/news/")
})
